...
# Create Subset of Credentials
firewall_client = boto3.client(
    'sts',
    aws_access_key_id = (credresponse['AccessKeyId']),
    aws_secret_access_key = (credresponse['SecretAccessKey']),
    aws_session_token = (credresponse['SessionToken']) )


optimizely_role_object = firewall_client.assume_role(
    RoleArn="arn:aws:iam::201492179008:role/SubDev",
    RoleSessionName=str("default"),
    DurationSeconds=3600)

# Create Subset of Credentials
credsubresponse = optimizely_role_object['Credentials']
print ('\n\n---------------Subset Credentials-------------------------------')
print ('aws_access_key_id=', credsubresponse['AccessKeyId'])
print ('aws_secret_access_key=', credsubresponse['SecretAccessKey'])
print ('aws_session_token=', credsubresponse['SessionToken'])
print ('aws_expiration_key=', credsubresponse['Expiration'])
print ('----------------------------------------------------------------\n\n')
